  ...
  return (
    <section ref={containerRef} className="relative h-screen min-h-[700px] overflow-hidden bg-slate-950">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={heroImages[0]} alt={hero.backgroundImages[0]?.alt}
          className="w-full h-[130%] object-cover object-center" loading="eager" />
        <div className="absolute inset-0 bg-gradient-to-r from-slate-950/90 via-slate-950/60 to-slate-950/30 z-[1]" />
      </motion.div>
      <NoiseTexture opacity={0.04} />
      <motion.div className="relative z-20 flex flex-col justify-center h-full max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 pt-36" style={{ opacity }}>
        <div className="max-w-2xl">
          <motion.div initial={{ scaleX: 0 }} animate={{ scaleX: 1 }} transition={{ duration: 0.8 }}
            className="w-16 h-[3px] bg-blue-500 mb-6 origin-left" />
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}
            className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/30 px-4 py-2 mb-8">
            <Ruler size={14} weight="fill" className="text-blue-400" />
            <span className="text-blue-300 text-[10px] font-bold uppercase tracking-[0.15em]">Project Calculator</span>
          </motion.div>
          <div className="overflow-hidden">
            <motion.h1 initial={{ y: '100%' }} animate={{ y: 0 }} transition={{ duration: 1, delay: 0.5, ease: [0.16, 1, 0.3, 1] }}
              ...
              CALCULATE.<br /><span className="text-blue-500 italic font-bold">BUILD RIGHT.</span>
            </motion.h1>
          </div>
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1 }}
            className="text-white/40 text-sm leading-relaxed mt-6 max-w-lg" style={{ fontFamily: 'var(--font-sans)' }}>
            {hero.badge}. Know exactly what you need before you buy. Our team helps you get it right the first time.
          </motion.p>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.2 }} className="flex flex-wrap gap-4 mt-10">
            ...
            <Link to="/services" className="group inline-flex items-center gap-3 border border-white/15 text-white px-8 py-4 text-sm uppercase tracking-[0.15em] font-semibold hover:border-blue-500/40 hover:text-blue-400 transition-all" style={{ fontFamily: 'var(--font-sans)' }}>
              {hero.ctaSecondary}
            </Link>
          </motion.div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.9 }}>
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-8" style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
              The Super<br /><span className="text-blue-500">Story</span>
            </h2>
            {about.story.map((p, i) => (
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}}
            ...
            <h2 className="font-heading text-white leading-[0.95] italic mb-12" style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}>
              Why Choose <span className="text-blue-500">Super</span>
            </h2>
...
function CTASection() {
  ...
  return (
    <section ref={ref} className="relative py-28 sm:py-36 lg:py-48 overflow-hidden">
      <motion.div className="absolute inset-0" style={{ y: bgY }}>
        <img src={siteData.hero.backgroundImages[0]?.url} alt="Super Natural Hardware" className="w-full h-[130%] object-cover object-center" loading="lazy" />
